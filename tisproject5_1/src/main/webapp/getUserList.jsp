				...
				<main>
					...
					<table class="userList">
						...
						<tr class="listTitle">
							...
							<td class="listvalue"><fmt:formatDate value="${user.birthday}" pattern="yyy-MM-dd" /></td>
							<td class="listvalue">${user.gender}</td>
							<td class="listvalue">${user.favorite_genre1}<br>${user.favorite_genre2}<br>${user.favorite_genre3}</td>
							<td class="listvalue">${user.rank}</td>
						</tr>
						</c:forEach>
					</table>
					<br>
