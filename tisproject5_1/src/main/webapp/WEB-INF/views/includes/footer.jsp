...
<footer class="footer">
	<ul class="footerService clear">
		<li class="footerTurmsOfUse footerPopupBtn">
			서비스 이용약관
		</li>
		<li>
			|
		</li>
		<li class="footerPrivacyPolicy footerPopupBtn">
			개인정보 처리 방침
		</li>
		<li>
			|
		</li>
		<li class="footerServiceCenter">
			고객센터
		</li>
	</ul>
	<ul class="footerContact">
		<li>
			<span class="footerContactLeft">고객센터(이용 및 결제 문의)</span>
			<span class="footerContactRight">| email@naver.com / 02-123-4567 (유료)</span>
		</li>
		<li>
			<span class="footerContactLeft">제휴 및 대외 협력</span>
			<span class="footerContactRight">| https://site.team/contact</span>
		</li>
		<li>
			<span class="footerContactLeft">B2B 이용권 구매 문의</span>
			<span class="footerContactRight">| 꾸꾸마케팅 (email1234@naver.com / 070-1234-5678)</span>
		</li>
	</ul>
</footer>
<div id="turmsOfUse" class="popup">
	<div class="popupBox">
		<div class="popupHead clear">
			<h2 class="popupTitle">서비스 이용약관</h2>
			<button class="popupClose">X</button>
		</div>
		<p class="popupText">
제1조(목적)<br>
<br>
이 이용약관(이하 '약관')은 주식회사 'Project'(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다. <br>
<br>
제2조(이용약관의 효력 및 변경)<br>
<br>
① 이 약관은 본 회사에 가입된 고객을 포함하여 서비스를 이용하고자 하는 모든 이용자에 대하여 서비스 메뉴 및 회사에 게시하여 공시하거나 기타의 방법으로 고객에게 공지함으로써 그 효력을 발생합니다. 약관의 게시는 OOO(http://www.OOO.com)사이트에서 확인 할 수 있습니다.<br>
...
제17조(계약 변경 및 해지)<br>
<br>
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 'Cocktail' 웹 내의 "회원탈퇴"메뉴를 이용해 가입해지를 해야 합니다.<br>
<br>
제18조(서비스 이용제한)<br>
<br>
...
<br>
이 약관은 2022년 03월 01일부터 시행합니다.	<br>
...
<div id="privacyPolicy" class="popup">
	<div class="popupBox">
		<div class="popupHead clear">
			<h2 class="popupTitle">개인정보 처리방침</h2>
			<button class="popupClose">X</button>
		</div>
		<p class="popupText">
'Project'은 (이하 '단체'는)<br>
고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br>
<br>
단체는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.<br>
<br>
<br>
단체는 개인정보취급방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.<br>
<br>
■ 수집하는 개인정보 항목<br>
<br>
